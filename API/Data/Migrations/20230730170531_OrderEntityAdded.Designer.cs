...
namespace API.Data.Migrations
{
    ...
    [Migration("20230730170531_OrderEntityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.OrderAgggregate.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Entities.OrderAgggregate.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Entities.OrderAgggregate.OrderItem", b =>
                {
                    b.HasOne("API.Entities.OrderAgggregate.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId");

                    b.OwnsOne("API.Entities.OrderAgggregate.ProductItemOrdered", "ItemOrdered", b1 =>
                        {
